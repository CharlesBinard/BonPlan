...
// import.meta.dir = .../packages/gateway/src, so ../../shared/drizzle = .../packages/shared/drizzle
...
app.use("/*", serveStatic({ root: frontendDist }), serveStatic({ root: frontendDist, path: "index.html" }));
